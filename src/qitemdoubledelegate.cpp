...
QItemDoubleDelegate::QItemDoubleDelegate() : QStyledItemDelegate()
{

}

QItemDoubleDelegate::~QItemDoubleDelegate()
{
...
QString QItemDoubleDelegate::displayText(const QVariant & value, const QLocale & locale) const
{
    bool ok;
